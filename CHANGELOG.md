...
- Span each probe's check strip across its card with 40 slots, and show details when you hover over or tap a status block: probe checks, service rows, and days in the 90-day strip.
