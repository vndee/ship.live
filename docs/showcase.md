...
Team dashboards also offer Review Radar, GitHub deployment state, Service Health, and the leaderboard as tabs, with an optional auto-slide between them, without requiring a second workflow from the team.
